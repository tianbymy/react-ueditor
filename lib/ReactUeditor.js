...
function (_React$Component) {
  ...
  function ReactUeditor(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ReactUeditor).call(this, props)); //this.content = props.value || '' // 存储编辑器的实时数据，用于传递给父组件
    ...
    _defineProperty(_assertThisInitialized(_this), "initEditor", function () {
      var _this$props4 = _this.props,
          ...
          editValue = _this$props4.editValue,
      ...
      _this.ueditor.ready(function () {
        ...
        if (_this.isContentChangedByWillReceiveProps) {
          ...
          _this.ueditor.setContent(_this.props.editValue);
        }
...
_defineProperty(ReactUeditor, "propTypes", {
  ...
  editValue: _propTypes.default.string,
